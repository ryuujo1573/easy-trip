...
class MarkdownStyleSheet {
  ...
  MarkdownStyleSheet({
    ...
    this.tableHeadAlign,
    this.tableBorder,
    this.tableColumnWidth = const FlexColumnWidth(1),
    this.tableColumnWidthBuilder,
  ...
  MarkdownStyleSheet copyWith({
    ...
    TableColumnWidth Function(int)? tableColumnWidthBuilder,
    ...
    return MarkdownStyleSheet(
      ...
      tableColumnWidthBuilder: tableColumnWidthBuilder ?? this.tableColumnWidthBuilder,
  ...
  MarkdownStyleSheet merge(MarkdownStyleSheet? other) {
    ...
    return copyWith(
      ...
      tableColumnWidthBuilder: other.tableColumnWidthBuilder,
  ...
  /// The function to use for building Table with different width. [[modified by ryuujo]]
  final TableColumnWidth Function(int index)? tableColumnWidthBuilder;
  // ToDo: Builder for named columns.
  ...
  bool operator ==(dynamic other) {
    ...
    return typedOther.a == a &&
        ...
        typedOther.tableColumnWidthBuilder == tableColumnWidthBuilder &&
